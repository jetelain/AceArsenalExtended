...
private _configs = "isText (_x >> 'XtdGearInfo' >> 'model')" configClasses (configFile >> _classRoot);
{
...
private _models  = "isArray (_x >> 'options')" configClasses (configFile >> "XtdGearModels" >> _classRoot);
{
	...
	private _modelConfigs = ("getText (_x >> 'XtdGearInfo' >> 'model') == '"+_model+"'") configClasses (configFile >> _classRoot);
